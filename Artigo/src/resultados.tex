...
\textbf{Limitações declaradas:} (1) o peso usado para a MWD é uma média simples das três estações de tratamento, não o peso real de cada uma dentro do total importado (não publicado nos relatórios); (2) a correlação é anual, não mensal -- não permite testar defasagem fina como foi feito com o PDSI; (3) 14 dos 21 anos (67\%) foram verificados por amostragem, não individualmente; (4) o relatório cobre o abastecimento da cidade de Los Angeles (lado LADWP), não o lado Glendale da área de serviço da LAGWRP, cujo dado equivalente ainda não foi obtido. Detalhes completos em D-54.

...
Completando os 9 métodos da seção 3.f do plano original, cinco métodos adicionais foram implementados (\texttt{script\_22} a \texttt{script\_26}), elevando a bateria de 27 para 34 métodos.

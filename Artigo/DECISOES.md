...
- **Verificação concluída (2026-09-01):** reaberto manualmente e conferido célula a célula, contra o PDF original, uma amostra de 4 anos do meio da série (2010, 2014, 2018, 2021), somados aos 3 já conferidos antes (2004, 2005, 2024) — **7 de 21 anos (33%) verificados, zero discrepâncias em qualquer célula** (TDS médio, faixa min-max, e percentual de mistura, nas 6 fontes de cada ano). Amostra cobre início, meio e fim da série, em anos de regime climático variado (seco: 2014, 2021; úmido: 2010; misto: 2018) — não só anos "fáceis". Não há evidência de erro sistemático de extração; o resultado é tratado como confiável para uso no artigo.
- **Limitação que permanece, mesmo após a verificação:** os outros 14 anos (67%) não foram conferidos individualmente — a amostra de 7 é uma verificação por amostragem, não uma auditoria de 100% dos dados. O peso usado para "MWD" na ponderação é uma média simples das 3 ETAs (Weymouth/Diemer/Jensen), não o peso real de cada uma dentro do total importado (esse detalhe não está nos relatórios). E a correlação é anual (14 pontos), não mensal — não permite testar defasagem fina como foi feito com o PDSI em D-37.

...
from utils.validacao_utils import validar_metodo
...
COMPARACAO_ANTES_DEPOIS_CSV = result("comparacao_pdsi_antes_depois.csv")
FIGURA_PATH = figure("bateria-pdsi-covariavel-comparacao.png")

...
RESULTADOS_CSV = result("vazao_reconstruida_resultados.csv")
RESULTADOS_JSON = result("vazao_reconstruida_resultados.json")
VAZAO_SERIE_CSV = processed("vazao_reconstruida_serie.csv")
FIGURA_PATH = figure("vazao-reconstruida.png")
ARQUIVOS = {"TDS": raw("TDS.csv"), "Chloride": raw("Chloride.csv"), "Ammonia": raw("Ammonia.csv"), "BOD": raw("BOD.csv")}

...
from utils.paths import (
    ...
    result,
    figure,
    RESULTADOS_COMPARACAO_CSV,
    RESULTADOS_COMPARACAO_JSON,
)
bootstrap_sys_path()
...
RAW_STATE = raw("pdsi_raw_climdiv_state.txt")
RAW_DIV = raw("pdsi_raw_climdiv.txt")
SERIES_ALVO = {
    "california_estadual": {"tipo": "estado", "prefixo": "004005", "arquivo_saida": processed("pdsi_california_estadual.csv")},
    "los_angeles_divisao6": {"tipo": "divisao", "prefixo": "040605", "arquivo_saida": processed("pdsi_los_angeles_divisao.csv")},
    "sacramento_divisao2": {"tipo": "divisao", "prefixo": "040205", "arquivo_saida": processed("pdsi_sacramento_divisao.csv")},
}
...
RESULTADOS_CSV = result("pdsi_regimes_resultados.csv")
RESULTADOS_JSON = result("pdsi_regimes_resultados.json")
FIGURA_OVERLAY = figure("pdsi-vs-tds-regimes.png")
FIGURA_CCF = figure("pdsi-tds-correlacao-defasagem.png")
MAX_LAG_MESES = 36
...
def carregar_vazao() -> pd.Series:
    v = pd.read_csv(processed("vazao_reconstruida_serie.csv"), parse_dates=["Data"])

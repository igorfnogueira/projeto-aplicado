...
RESULTADOS_CSV = result("matriz_sensibilidade_resultados.csv")
RESULTADOS_JSON = result("matriz_sensibilidade_resultados.json")
FIGURA_PATH = figure("matriz-sensibilidade.png")
MDL_BOD = 3.0

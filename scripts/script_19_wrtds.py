...
RESULTADOS_CSV = result("wrtds_resultados.csv")
RESULTADOS_JSON = result("wrtds_resultados.json")
RESULTADOS_COMPARACAO_CSV = RESULTADOS_COMPARACAO_CSV
RESULTADOS_COMPARACAO_JSON = RESULTADOS_COMPARACAO_JSON
FIGURA_PATH = figure("wrtds-flow-normalized.png")
FIGURA_CIRCULARIDADE = figure("wrtds-circularidade.png")

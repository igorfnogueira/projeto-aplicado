...
TDS_CSV = raw("TDS.csv")
LADWP_CSV = processed("ladwp_tds_por_fonte_historico.csv")
SAIDA_CSV = processed("ladwp_tds_origem_vs_efluente.csv")
FIGURA = figure("ladwp-tds-origem-vs-efluente.png")

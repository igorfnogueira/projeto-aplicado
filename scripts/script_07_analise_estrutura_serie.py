...
RESULTADOS_CSV = result("diagnostico_serie_resultados.csv")
RESULTADOS_JSON = result("diagnostico_serie_resultados.json")
FIGURA_PATH = figure("diagnostico-sazonalidade-quebras.png")
PERIODO_SAZONAL = 12

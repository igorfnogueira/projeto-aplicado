...
RESULTADOS_CSV = result("balanco_massa_resultados.csv")
RESULTADOS_JSON = result("balanco_massa_resultados.json")
RESULTADOS_COMPARACAO_CSV = RESULTADOS_COMPARACAO_CSV
RESULTADOS_COMPARACAO_JSON = RESULTADOS_COMPARACAO_JSON
FIGURA_DECOMP = figure("balanco-massa-decomposicao.png")
FIGURA_VALIDACAO = figure("balanco-massa-validacao.png")
...
def main():
    ...
    vazoes = pd.read_csv(processed("vazao_reconstruida_serie.csv"), parse_dates=["Data"])

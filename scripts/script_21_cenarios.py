...
ARQUIVO_PDSI = processed("pdsi_california_estadual.csv")
RESULTADOS_CSV = result("cenarios_resultados.csv")
RESULTADOS_JSON = result("cenarios_resultados.json")
RESULTADOS_COMPARACAO_CSV = RESULTADOS_COMPARACAO_CSV
RESULTADOS_COMPARACAO_JSON = RESULTADOS_COMPARACAO_JSON
FIGURA_FAN = figure("cenarios-pdsi-fanchart.png")
FIGURA_HORIZONTES = figure("cenarios-pdsi-horizontes.png")
def carregar_lag_otimo() -> int:
    df = pd.read_csv(result("pdsi_regimes_resultados.csv"))

...
RESULTADOS_CSV = result("diagnostico_residuos_resultados.csv")
RESULTADOS_JSON = result("diagnostico_residuos_resultados.json")
FIGURA_PATH = figure("diagnostico-residuos-finalistas.png")
SEED = 42
LAG_LJUNG_BOX = 12
